...
export const QuizApp = () => {
  ...
  const questions = [
    ...
    {
      question: "What is the capital of France?", // Pergunta da terceira questão.
      options: ["Berlin", "Madrid", "Paris", "Lisbon"], // Opções de resposta para a terceira questão.
      answer: "Paris", // Resposta correta para a terceira questão.
    },
    {
      question: "Which planet is known as the Red Planet?", // Pergunta da quarta questão.
      options: ["Earth", "Mars", "Jupiter", "Saturn"], // Opções de resposta para a quarta questão.
      answer: "Mars", // Resposta correta para a quarta questão.
    },
    {
      question: "What is the boiling point of water?", // Pergunta da sexta questão.
      options: ["50°C", "75°C", "100°C", "125°C"], // Opções de resposta para a sexta questão.
      answer: "100°C", // Resposta correta para a sexta questão.
    },
    {
      question: "What is the chemical symbol for gold?", // Pergunta da sétima questão.
      options: ["Ag", "Au", "Pb", "Fe"], // Opções de resposta para a sétima questão.
      answer: "Au", // Resposta correta para a sétima questão.
    },
    {
      question: "In what year did the Titanic sink?", // Pergunta da nona questão.
      options: ["1912", "1905", "1920", "1898"], // Opções de resposta para a nona questão.
      answer: "1912", // Resposta correta para a nona questão.
    },
    {
      question: "What is the square root of 64?", // Pergunta da décima questão.
      options: ["6", "7", "8", "9"], // Opções de resposta para a décima questão.
      answer: "8", // Resposta correta para a décima questão.
    },
    {
      question: "What is the capital city of Japan?", // Pergunta da décima segunda questão.
      options: ["Beijing", "Seoul", "Tokyo", "Bangkok"], // Opções de resposta para a décima segunda questão.
      answer: "Tokyo", // Resposta correta para a décima segunda questão.
    },
  ];
